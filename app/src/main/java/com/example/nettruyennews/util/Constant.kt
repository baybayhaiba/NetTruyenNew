...
object Constant {
    const val VERSION = 1
    const val URL_HOME = "http://www.nettruyenco.com/?page="
    const val URL_RANK = "http://www.nettruyenco.com/tim-truyen?status=-1&sort=10&page="
    const val URL_ORIGNAL = "http://www.nettruyenco.com/"
